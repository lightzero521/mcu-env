...
from mcuenv.util import CommandTimer, is_windows, make_verbose_build_output_filter, run_command
    ...
    *,
    ...
    with CommandTimer("Build"):
        ...
        if verbose:
            ...
            transform_line = make_verbose_build_output_filter(project.root)
        code = run_command(build_args, verbose=verbose, transform_line=transform_line)
        if code != 0:
            return code
